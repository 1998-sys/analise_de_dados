...
FUNCOES_AGGO = {'soma': 'sum', 'contagem': 'count'}
...
metrica_analise = st.sidebar.selectbox('Selecionar a métrica', list(FUNCOES_AGGO.keys()))


if len(indice_dinamico) > 0 and len(coluna_dinamica) > 0:
    metrica = FUNCOES_AGGO[metrica_analise]

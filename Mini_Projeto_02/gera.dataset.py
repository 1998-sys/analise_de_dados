...
LOJAS = [
    ...
    {'estado': 'RS', 'cidade': 'Porto Alegre',
     'vendedores':['Mariana Gomes', 'Roberto Firmino']},
    {'estado': 'SC', 'cidade': 'Florianópolis',
     'vendedores':['Gabriela Santos', 'Tiago Lima']},
]

PRODUTOS = [
    {'nome': 'Smartphone Samsumg Galaxy', 'id':0, 'preco': 2500},
...
FORMA_PGT = ['Cartão de Crédito', 'Boleto', 'Pix', 'Dinheiro']
GENERO_CLIENTES = ['male', 'famele']
...
for _ in range(2000):
    ...
    forma_pagto = random.choice(FORMA_PGT)
